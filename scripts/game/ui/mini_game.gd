...
static var mini_game_scene_map={
	Enums.MiniGame.JUST_CHATTING_TOPIC_SEARCH:preload("res://scenes/game/rhythm_pop.tscn"),
	Enums.MiniGame.SINGING_PRACTICE:preload("res://scenes/game/rhythm_pop.tscn"),
	Enums.MiniGame.GAME_SEARCH:preload("res://scenes/game/rhythm_pop.tscn")
}
